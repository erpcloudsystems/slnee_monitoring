...
def get_item_price_qty_data(filters):
    ...
    item_results = frappe.db.sql("""
				select distinct
						...
						(select count(name) from `tabPress Monitoring` b where b.content_item ='خبر' and a.journal = b.journal and a.service_classification = b.service_classification {conditions} ) as count_of_press_release,
