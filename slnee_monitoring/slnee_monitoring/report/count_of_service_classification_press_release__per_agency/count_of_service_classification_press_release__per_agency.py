...
def get_item_price_qty_data(filters):
    ...
    item_results = frappe.db.sql("""
				select distinct
						a.agency as agency,
						(select count(name) from `tabPress Monitoring` b where a.agency =b.agency and a.service_classification = b.service_classification {conditions} ) as count_of_press_release
